...
def build_model(df):
    ...
    # st.markdown(filedownload(pickle.dump(predictions_test, open('filename.sav', 'wb')),unsafe_allow_html=True)

    saved_model = pickle.dump(reg,open('reg.pkl', 'wb')) # saving in local
